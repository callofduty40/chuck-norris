...
function handleCategoryChange(event) {
 ...
 return (
    ...
    <div className="container">
      <div>
        <div className="logo" align="center"><img class="img-fluid d-block rounded-circle mx-auto" src="/chuck.png"></img></div>
      </div>
      <div>
        <select id="menu" value={selectedCategory} onChange={handleCategoryChange}>
        ...
        <div className="col-md-12"><textarea className="text" ref={textareaRef} id="menu" rows="4" cols="50" value={joke}></textarea></div>
